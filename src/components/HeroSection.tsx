...
const floatingElements = [
  { text: "education", delay: 0.2, class: "top-[10%] left-[10%]" },
  { text: "experience", delay: 0.4, class: "top-[20%] right-[15%]" },
  { text: "skills", delay: 0.6, class: "bottom-[30%] left-[20%]" },
  { text: "languages", delay: 0.8, class: "bottom-[20%] right-[10%]" },
];
      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className={`relative ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: "0.3s" }}>
            <div className="relative aspect-[4/5] bg-gradient-to-tr from-green-500/20 to-red-500/20 rounded-xl overflow-hidden border border-white/20 shadow-xl">
