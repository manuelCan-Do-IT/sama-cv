  ...
  return <header className={cn("sticky top-0 z-40 w-full transition-all duration-200", scrolled ? "bg-background/80 backdrop-blur-md border-b shadow-sm" : "bg-transparent")}>
      <div className="container flex h-16 items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          <img alt="SamaCV" height="40" className="h-30 object-cover" src="/lovable-uploads/5d674f1d-8f0f-41bb-a211-e4e0e440de91.png" />
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          {isMobile && <Button variant="outline" size="icon" className="md:hidden" onClick={() => setIsOpen(!isOpen)}>
